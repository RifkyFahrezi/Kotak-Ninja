...
function renderScoreHud() {
    ...
    cubeCountNode.innerText = `Slepetan : ${state.game.cubeCount}`;
    ...
    switch (state.menus.active) {
        ...
        case MENU_SCORE:
            ...
            if (isNewHighScore()) {
                ...
                highScoreLblNode.textContent = 'Skor Anyar!';

            } else {

                highScoreLblNode.textContent = `Skor Paling Dhuwur: ${formatNumber(getHighScore())}`;
